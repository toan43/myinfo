...
const EDUCATION_ROWS = RESUME.educationRows;
        ...
        {active === 0 && (
          <div className="resume-detail-panel">
            <div className="resume-detail-top">
              <div className="resume-detail-top-index">{RESUME.detailTop.index}</div>
              <div className="resume-detail-top-title">{RESUME.detailTop.title}</div>
              <div className="resume-detail-top-progress">{RESUME.detailTop.progress}</div>
            </div>
            ...
            <div className="resume-detail-bottom">
              ...
              <div className="resume-detail-bullets">
                {RESUME.detailBullets.map((line, i) => (
                  <div className="resume-detail-bullet" key={i}>{line}</div>
                ))}
              </div>
            </div>
          </div>
