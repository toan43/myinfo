...
import { ABOUT, CHARS } from "./content";

const MAIN_IMAGES = ABOUT.portraits;
const REVEAL_CONTENT = ABOUT.reveal;
const ITEMS = ABOUT.bars;
  ...
  return (
    <div id="menu-screen">
      ...
      <style>{`
        ...
        /* Nhóm ◄LB và RB► bấm được để chuyển mục */
        .sc-nav-group {
          display: flex;
          align-items: center;
          gap: 6px;
        ...
        .sc-nav-group:hover { transform: scale(1.08); }
        .sc-nav-group:active { transform: scale(0.96); }
      ...
      <div className="sc-root" role="navigation">
        {ITEMS.map((item, i) => (
          <div
            ...
            onClick={() => {
              // Bấm 1 lần: luôn mở/chuyển sang thanh này (đóng bằng nút BACK hoặc bấm nền tối)
              setActive(i);
              setRevealed(true);
            }}
            onMouseEnter={() => {
              // Chỉ đổi lựa chọn khi chưa mở, tránh việc rê chuột làm đóng chi tiết
      ...
      <BackButton onClick={() => (revealed ? setRevealed(false) : navigate("/"))} />
    </div>
  );
}
